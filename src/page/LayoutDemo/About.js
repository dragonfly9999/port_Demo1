...
const About = () => {
  return (
    ...
    >
      <ScrollAnimation animateIn="animate__fadeInDown" duration={3} delay={600}>
            ...
            <div className="tittle-content text-center leading-6 tracking-normal">
              ...
              <div className="infor mt-7 text-white font-semibold">
                <p>
                  ...
                  extensive professional experience up to this point. However, I
                  aspire to utilize the knowledge acquired during my university
                  education along with the learning opportunities at Cybersoft.
                  I am hopeful to contribute to the company and grow
                  professionally. Enclosed is a simple PDF resume for your
